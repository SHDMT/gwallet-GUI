      ...
      >
        <div className="paymentconfirm-modal-content">
          <div className="paymentconfirm-label-item first">
            <span className="paymentconfirm-label-item-title">付款账户：</span><span className="paymentconfirm-label-value">{account}</span>
          </div>
          <div className="paymentconfirm-label-item">
            <span className="paymentconfirm-label-item-title paymentconfirm-label-item-addrtitle">收款地址：</span>
            <div className="paymentconfirm-label-value">
              {this.props.target.map((addr, index) => (
